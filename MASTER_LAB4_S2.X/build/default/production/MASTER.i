...
void I2C_Master_Write(unsigned long d);

unsigned long I2C_Master_Read(unsigned long a);
...
uint8_t tempB;
uint8_t tempC;
uint8_t val_canal0 = 0;
uint8_t config;
uint8_t ctrl_meas;
signed long temperature;

uint8_t voltage1 [4] = {0,0,0,0};
uint16_t calor [5] = {0,0,0,0,0};



void setup (void);
void valor_voltaje(int valor_adc);
long int temperatura(uint8_t a, uint8_t b, uint8_t c);
